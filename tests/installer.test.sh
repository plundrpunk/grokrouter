...
grep -Fq 'let failurePrefixPayload = Data(' "$PROJECT_ROOT/installer/GrokBotRouterInstaller.swift"
grep -Fq '"GROKROUTER_\(installAttempt)_INSTALL_FAILED_UNKNOWN_CODE_".utf8' "$PROJECT_ROOT/installer/GrokBotRouterInstaller.swift"
! grep -Fq 'echo GROKROUTER_\(installAttempt)_INSTALL_FAILED_UNKNOWN_CODE_$code' "$PROJECT_ROOT/installer/GrokBotRouterInstaller.swift"
